...
static char *fonts[] = {
	"LiberationMono:pixelsize=14:antialias=true:autohint=true",
	"JoyPixels:pixelsize=10:antialias=true:autohint=true"};
static char normbgcolor[] = "#0a1e1a";
static char normbordercolor[] = "#0a1e1a";
static char normfgcolor[] = "#dea467";
static char selfgcolor[] = "#0a1e1a";
static char selbordercolor[] = "#dea467";
static char selbgcolor[] = "#dea467";
...
const char *spcmd2[] = {TERMINAL, "-n", "spcalc", "-f", "monospace:size=16", "-g", "50x20",
						"-e",	  "bc", "-lq",	  NULL};
...
/* tagging */
static const char *tags[] = {"㆒", "㆓", "㆔", "㆕", "・", "ロ", "リ", "コ", "ン"};
...
static const Rule rules[] = {
	...
	{NULL, NULL, "Event Tester", 0, 0, 0, 1, -1},  {NULL, "spterm", NULL, SPTAG(0), 1, 1, 0, -1},
...
static Key keys[] = {
	...
	STACKKEYS(MODKEY, focus) STACKKEYS(MODKEY | ShiftMask, push){
		MODKEY, XK_Escape, spawn, SHCMD("sudo systemctl restart sddm")},
	...
	{MODKEY | ShiftMask, XK_x, spawn, SHCMD("slock & xset dpms force off; mpc pause; pauseallmpv")},
